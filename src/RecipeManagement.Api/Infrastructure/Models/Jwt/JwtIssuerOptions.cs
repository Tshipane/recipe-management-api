...
namespace RecipeManagement.Api.Infrastructure.Models.Jwt
{
   public class JwtIssuerOptions
    {
        ...
        /// <summary>
        /// Set the timespan the token will be valid for (default is 7 days)
        /// </summary>
        public static TimeSpan ValidFor => TimeSpan.FromDays(7);
